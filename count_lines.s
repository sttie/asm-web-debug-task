/*
    ...
    При этом каждая строка задается своим указателем на первый элемент этой строки.
...
count_lines:
    /* Аргументы:
        rdi = указатель на первую строку двумерного массива,
        rsi = кол-во строк,
        rdx = кол-во столбцов
    */
...
start_main_loop:
    ...
    cols_loop:
        ...
        rows_loop:
            ...
            /* если текущее значение равно 0, то увеличиваем rax и обновляем ответ
               иначе просто обнуляем rax */
            cmp dl, 0
            jne dl_is_not_0
